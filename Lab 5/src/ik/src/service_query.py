...
def main():
    ...
    while not rospy.is_shutdown():
        x = raw_input('Press enter x to compute an IK solution:')
        y = raw_input('Press enter y to compute an IK solution:')
        z = raw_input('Press enter z to compute an IK solution:')
