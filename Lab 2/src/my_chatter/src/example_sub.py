...
def callback(message):
    ...
    print("Message: " + message.message + ", Sent at: %s" % (message.time) + ", Received at: %s" % (rospy.get_time()))   
    # print("Message: " + message.data[0:message.data.rfind(" ")] + ", Sent at: " + message.data[message.data.rfind(" ") + 1:] + ", Received at: " + " %s" % (rospy.get_time()))
