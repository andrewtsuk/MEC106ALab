...
def talker():
    ...
    while not rospy.is_shutdown():
        ...
        messagein = raw_input("Please enter a line of text and press <Enter>:")

        test = TimestampString(message = messagein, time = rospy.get_time())
        # pub_string = message + " %s" % (rospy.get_time())
